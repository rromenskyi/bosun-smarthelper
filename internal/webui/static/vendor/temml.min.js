/* Temml v0.13.4 — LaTeX-to-MathML renderer, https://github.com/ronkok/Temml
 * MIT License, Copyright (c) 2020 Ron Kok. Vendored verbatim (minified
 * build from the npm package's dist/temml.min.js) — a plain global
 * script (window.temml), not an ES module; see index.html for how it's
 * loaded before the main module script that calls it. No fonts, no CSS,
 * no CDN: rendering relies on the browser's own native MathML support
 * (Chrome, Firefox, Safari all ship one) rather than KaTeX's bundled
 * webfonts, which is the whole reason this one was chosen. */
